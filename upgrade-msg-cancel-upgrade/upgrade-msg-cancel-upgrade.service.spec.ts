...
describe('ProcessorsService::UpgradeMsgCancelUpgradeService', () => {
  ...
  it('should generate an alert for transactions for upgrade-msg-cancel-upgrade', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving upgrade-msg-cancel-upgrade', async () => {
    // todo
  });
});

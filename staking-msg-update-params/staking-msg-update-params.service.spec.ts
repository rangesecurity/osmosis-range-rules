...
describe('ProcessorsService::StakingMsgUpdateParamsService', () => {
  ...
  it('should generate an alert for transactions for staking-msg-update-params', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving staking-msg-update-params', async () => {
    // todo
  });
});

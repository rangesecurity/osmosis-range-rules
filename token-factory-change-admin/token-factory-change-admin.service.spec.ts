...
describe('ProcessorsService::TokenFactoryChangeAdminService', () => {
  ...
  it('should generate an alert for transactions for token-factory-change-admin', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving token-factory-change-admin', async () => {
    // todo
  });
});

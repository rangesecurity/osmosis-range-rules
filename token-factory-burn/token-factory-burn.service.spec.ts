...
describe('ProcessorsService::TokenFactoryBurnService', () => {
  ...
  it('should generate an alert for transactions for token-factory-burn', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving token-factory-burn', async () => {
    // todo
  });
});

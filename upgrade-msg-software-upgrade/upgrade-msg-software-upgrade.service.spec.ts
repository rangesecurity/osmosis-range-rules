...
describe('ProcessorsService::UpgradeMsgSoftwareUpgradeService', () => {
  ...
  it('should generate an alert for transactions for upgrade-msg-software-upgrade', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving upgrade-msg-software-upgrade', async () => {
    // todo
  });
});

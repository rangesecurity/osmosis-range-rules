...
describe('ProcessorsService::TokenFactoryMintService', () => {
  ...
  it('should generate an alert for transactions for token-factory-mint', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving token-factory-mint', async () => {
    // todo
  });
});

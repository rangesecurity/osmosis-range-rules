...
describe('ProcessorsService::TokenFactorySetDenomMetadataService', () => {
  ...
  it('should generate an alert for transactions for token-factory-set-denom-metadata', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving token-factory-set-denom-metadata', async () => {
    // todo
  });
});

...
describe('ProcessorsService::StakeUnstakeService', () => {
  ...
  it('should generate an alert for transactions for stake-unstake', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving stake-unstake', async () => {
    // todo
  });
});

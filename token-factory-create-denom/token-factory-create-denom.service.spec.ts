...
describe('ProcessorsService::TokenFactoryCreateDenomService', () => {
  ...
  it('should generate an alert for transactions for token-factory-create-denom', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving token-factory-create-denom', async () => {
    // todo
  });
});
